class SubjectsController < ApplicationController
  before_action :set_student, only: [:index, :show, :edit, :create, :update, :destroy]
  ...
  def destroy
    @subject.destroy
    respond_to do |format|
      format.html { redirect_to student_path(@student), notice: 'Subject was successfully destroyed.' }
  ...
  private
    ...
    def subject_params
      params.require(:subject).permit(:student_id, :semestr, :name, :grade)
    end
end
