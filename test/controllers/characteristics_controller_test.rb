...
class CharacteristicsControllerTest < ActionController::TestCase
  ...
  test "should create characteristic" do
    assert_difference('Characteristic.count') do
      post :create, characteristic: { content: @characteristic.content, student_id: @characteristic.student_id, title: @characteristic.title }
    end
  ...
  test "should update characteristic" do
    patch :update, id: @characteristic, characteristic: { content: @characteristic.content, student_id: @characteristic.student_id, title: @characteristic.title }
    assert_redirected_to characteristic_path(assigns(:characteristic))
  end
