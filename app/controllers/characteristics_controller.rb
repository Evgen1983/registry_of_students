class CharacteristicsController < ApplicationController
  before_action :set_student, only: [:show, :edit, :create, :update, :destroy]
  ...
  def create
    @characteristic = @student.create_characteristic(characteristic_params)
  ...
  def update
    respond_to do |format|
      if @characteristic.update(characteristic_params)
        format.html { redirect_to student_path(@student), notice: 'Characteristic was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to student_path(@student), notice: 'Characteristic was successfully destroyed.' }
  ...
  private
    ...
    def set_characteristic
      @characteristic = @student.characteristic(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def characteristic_params
      params.require(:characteristic).permit( :id, :student_id, :title, :content)
    end
end
